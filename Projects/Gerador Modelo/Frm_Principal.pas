...
{ Acrescentar mais drivers onde no --> lstTabelas <-- é listado o NOME_DO_BANCO.TABELA }
...
procedure  TFrmPrincipal.LoadPropertys(Index : Integer);
  ...
  begin
     ...
     if Metadata.Locate('COLUMN_NAME',_Campo,[loCaseInsensitive]) then
      _PrimaryKey.Add('  [PrimaryKey('+QuotedStr(_Campo)+', NotInc, NoSort, False, '+QuotedStr('Chave primária')+')]');
